...
## Corpus Check
- 80 files · ~886,718 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 431 nodes · 583 edges · 40 communities (28 shown, 12 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a15a9a7`
...
Cohesion: 0.06
Nodes (39): Assignments API, Truck Manager Service, BaseModel, DashboardPage(), DashboardPageProps, CARDS, KpiCards(), KpiCardsProps (+31 more)
...
Cohesion: 0.07
Nodes (31): dependencies, axios, class-variance-authority, clsx, @fontsource-variable/geist, @geoman-io/leaflet-geoman-free, leaflet, leaflet.heat (+23 more)
...
Cohesion: 0.1
Nodes (17): MapHeatmapLayer(), MapLassoControl(), DEFAULT_ITEMS, LegendItem, MapLegend(), MapLegendProps, ColorMode, MapMarker() (+9 more)
...
Cohesion: 0.15
Nodes (13): fetchTruckCapacities(), fetchTrucks(), Coordinates API, Trucks API, Main Entry Point, Pydantic Schemas, Data Processor Service, Pending Orders Data (+5 more)
...
## Knowledge Gaps
- **205 isolated node(s):** `dev`, `build`, `lint`, `preview`, `@fontsource-variable/geist` (+200 more)
...
- **Why does `DataProcessor` connect `Community 16` to `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 4`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 1`, `Community 11`, `Community 13`?**
